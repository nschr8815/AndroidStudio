...
public class MainActivity extends AppCompatActivity {
    ...
    googleBtn.setOnClickListener(new View.OnClickListener(){
        ...
        button2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent launchIntent = getPackageManager().getLaunchIntentForPackage("org.westada.listview1");
                if (launchIntent != null) {
        ...
        button3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent launchIntent = getPackageManager().getLaunchIntentForPackage("org.westada.listview2");
                if (launchIntent != null) {
        ...
        button4.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent launchIntent = getPackageManager().getLaunchIntentForPackage("org.westada.polycalc");
                if (launchIntent != null) {
